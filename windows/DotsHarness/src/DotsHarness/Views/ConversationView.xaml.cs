...
public partial class ConversationView : UserControl
{
    ...
    private void OnModel(object? sender, PropertyChangedEventArgs e) => Dispatcher.Invoke(Bind);
    ...
    private void Bind()
    {
        ...
        StopButton.Visibility = conversation?.Running == true ? Visibility.Visible : Visibility.Collapsed;
    ...
    private void BindQuestion()
    {
        ...
        if (question is not null && question.SessionId == Model!.SelectedConversationId)
        {
            ...
            {
                var ok = new Button { Content = "OK", Padding = new Thickness(10, 4, 10, 4) };
