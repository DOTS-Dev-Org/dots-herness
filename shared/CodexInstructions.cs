...
// look like the official Codex CLI system prompt, so `CodexBody` mirrors it verbatim.
//
...
public static class CodexInstructions
{
    /// <summary>The official Codex CLI prompt, verbatim. The backend checks for it.</summary>
    public const string CodexBody = """
...
""";
    ...
    /// <summary>What this harness actually offers, reconciling the prompt above.</summary>
    public const string HarnessOverrides = """
## Harness overrides
