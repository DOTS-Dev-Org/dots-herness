...
enum HerNessPrompt {
    ...
    /// Computed so the date stays current in a long-running app.
    static var phone: String { core(
        scope: phoneScope,
        toolGuidance: "Use the provided tools for every file read, file write, and command."
    ) + """
    ...
    static func pluginGuidance(_ text: String) -> String {
